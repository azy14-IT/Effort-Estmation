...
public class DataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                Role leadRole = roleRepository.findAll().stream().filter(r -> r.getName().equals("Team Lead"))
                                .findFirst()
                                .orElse(null);
                ...
                createTask("Frontend Integration", "Connect Thymeleaf templates with Backend APIs.",
                                new BigDecimal("30.0"), project, null, Task.Priority.MEDIUM); // Unassigned (For anyone
                                                                                              // to pick)
